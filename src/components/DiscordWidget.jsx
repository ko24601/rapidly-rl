...
export default function DiscordWidget({ memberCount = '500+', onlineCount = '50+' }) {
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#80848e', flexShrink: 0 }} />
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'var(--muted)' }}>
            <strong style={{ color: 'var(--text)' }}>{memberCount}</strong> members
          </span>
        </div>
      </div>
